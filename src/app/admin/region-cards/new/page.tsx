...
function NewRegionCardForm() {
  ...
  const fetchNovels = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Set default novel if provided in URL
        if (novelIdParam && data.find((n: Novel) => n.id === parseInt(novelIdParam))) {
          setFormData(prev => ({ ...prev, novel_id: novelIdParam }));
        }
      }
    } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.novel_id || !formData.name.trim() || !formData.description.trim()) {
    ...
    try {
      ...
      alert('Error creating region card');
    } finally {
    ...
    <div className="min-h-screen pt-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 pb-32">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl font-bold text-white font-display">Create Region Card</h1>
            <p className="text-gray-300 mt-2">Add a new region or location to your world</p>
          </div>
          <Link 
            href="/admin"
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="border-t border-gray-700 pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {/* Theme Color */}
                <div>
                  <label htmlFor="theme_color" className="block text-sm font-medium text-white mb-2">
                    Theme Color
                  </label>
                  <div className="flex gap-2">
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-16 h-10 bg-gray-800 border border-gray-600 rounded-md cursor-pointer"
                    />
                    <input
                      type="text"
                      name="theme_color"
                ...
                {/* Border Color */}
                <div>
                  <label htmlFor="border_color" className="block text-sm font-medium text-white mb-2">
                    Border Style
                  </label>
                  <select
                    id="border_color"
                ...
                {/* Background Color */}
                <div>
                  <label htmlFor="background_color" className="block text-sm font-medium text-white mb-2">
                    Background Style
                  </label>
                  <select
                    id="background_color"
                ...
                {/* Hover Color */}
                <div>
                  <label htmlFor="hover_color" className="block text-sm font-medium text-white mb-2">
                    Hover Effect
                  </label>
                  <select
                    id="hover_color"
                ...
                {/* Layout Style */}
                <div>
                  <label htmlFor="layout_style" className="block text-sm font-medium text-white mb-2">
                    Layout Style
                  </label>
                  <select
                    id="layout_style"
