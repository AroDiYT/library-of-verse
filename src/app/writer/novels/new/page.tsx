  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push(`/writer/novels/${novel.id}`);
      } else {
      ...
      setErrors({ general: 'Failed to create novel. Please try again.' });
    } finally {
    ...
    <div className="min-h-screen bg-gray-900 text-white pt-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl font-bold text-white mb-2 font-display">Create New Novel</h1>
            <p className="text-gray-300">Set up your new story with its theme and settings</p>
          </div>
          <Link 
            href="/writer/novels"
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex gap-4">
            ...
            >
              {isSubmitting ? 'Creating Novel...' : 'Create Novel'}
            </button>
          </div>
        </form>
      </div>
